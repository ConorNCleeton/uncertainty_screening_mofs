function [objectives, constraints] = objective_evaluation(x,input,type,net_Pu,net_Re,net_Prod,net_En)
...
productivity = 10.^(net_Prod(input'));
energy_requirements = 10.^(net_En(input'));
...
switch type
    ...
    case 'EconomicEvaluation'
        objectives(1) = energy_requirements       ;
        objectives(2) = -productivity  ;
