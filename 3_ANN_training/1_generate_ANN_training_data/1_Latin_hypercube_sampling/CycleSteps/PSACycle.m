function  [purity,recovery,productivity,energy_requirments,cycle_iter] = PSACycle(vars, iso_params, x0, type, N)
...
%   Specify the parameters for the simulation
    ...
    % Supply input and sort parameters
    InputParams     = ProcessInputParameters(vars, iso_params_sort, N) ;
