function InputParams = ProcessInputParameters(process_vars, IsothermPar, N)
...
%% State all input parameters for the simulation
    ...
    ro_crys     = process_vars(8)       ;   % crystal density [kg/m^3]
    C_ps        = process_vars(9)       ;   % Specific heat capacity of the adsorbent [J/kg/K]
